...
웹캠 및 카메라 -> 사용자 EAR, 고개 -> 수면 감지 -> Dealy 5s -> 라즈베리파이 통신 -> 라즈베리파이 모터 작동 -> 전원 off
...
1. 개요
   ...
   다.
   그렇기 떼문에 불이 켜진 상태에서 수면을 취하게 된다면 수면의 질이 매우 떨어지는 요소를 시각적, 청각적 요소(TV 소리)등을 없애게 된다면 
...
이후, 관련된 내용의 경우, 2026학년도 1학기 캡스톤 진행 과정중에 있어, 차후 내용을 추가하도록하겠스빈다.
